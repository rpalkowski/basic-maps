...
knitr::opts_chunk$set(fig.width=14.5, fig.height=12, fig.path='wykresy/',
...
```{r results='hide'}
polska=readOGR(dsn="./pliki_shp/województwa.shp")
polska@data
names(polska)
```
...
```{r}
miasta=read.csv("./wspolrzedne.csv", header = TRUE, sep=";")
miasta
```
